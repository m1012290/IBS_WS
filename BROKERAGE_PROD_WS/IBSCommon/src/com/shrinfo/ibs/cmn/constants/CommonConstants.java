...
/**
 * @author Sunil Kumar Commonly used constants which would be used across the application would be
 *         added up here. For ex - APP_NAME, Enquiry types available etc
 */
