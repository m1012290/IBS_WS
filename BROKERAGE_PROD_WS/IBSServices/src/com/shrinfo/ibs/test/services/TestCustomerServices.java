...
public class TestCustomerServices {
	...
	public static void main(String args[]) {
		Utils.setAppContext(Utils
				.loadSpringBeansFactory("config/applicationcontext.xml"));

		CustomerEnquiryService customerService = (CustomerEnquiryService) Utils
				.getBean("customerEnquirySvc");
